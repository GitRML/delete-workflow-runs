...
![manual workflow](https://github.com/fxonei/delete-workflow-runs/blob/main/img/example.PNG)
```yaml
name: Delete old workflow runs
on:
  workflow_dispatch:
...
## License
The scripts and documentation in this project are released under the [MIT License](https://github.com/fxonei/delete-workflow-runs/blob/main/LICENSE).
##
